...
execute at @s if score #system WorkbenchCount matches 1 run execute unless data block ~ ~0.5 ~ {Items:[{Slot:1b,id:"minecraft:redstone"}]} run scoreboard players set #system WorkbenchCount 0
...
execute at @s if score #system WorkbenchCount matches 1 run execute unless data block ~ ~0.5 ~ {Items:[{Slot:4b,id:"minecraft:diamond"}]} run scoreboard players set #system WorkbenchCount 0
...
execute at @s if score #system WorkbenchCount matches 1 run execute unless data block ~ ~0.5 ~ {Items:[{Slot:7b,id:"minecraft:redstone"}]} run scoreboard players set #system WorkbenchCount 0
