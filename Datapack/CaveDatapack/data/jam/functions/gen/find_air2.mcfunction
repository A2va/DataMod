...
execute if score AIR TEMP matches 0 run scoreboard players remove Y TEMP 8
execute if score AIR TEMP matches 0 if score Y TEMP matches 12.. positioned ~ ~8 ~ run function jam:gen/find_air
